...
public class CognitoUserServiceImpl implements CognitoUserService {
    ...
    @Override
    public UserResponse mapToUserResponse(UserType userType) {
        return UserResponse.builder()
    ...
    @Override
    public String getAttributeValue(List<AttributeType> attributes, String attributeName) {
    ...
    @Override
    public void sortUsers(List<UserResponse> users, String sortBy, String sortDirection) {
